...
\item Project: ``Lipid extraction and swimbladder morphology in mesopelagic fish''
\end{cvitems}}
...
\item Project: ``Exploring the emergent niche of Greater argentine (\textbackslash emph\{Argentina silus\}) along gradients of topography and light''
\end{cvitems}}
\end{cventries}
